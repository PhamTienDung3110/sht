...
const mockQuestionsMath: Question[] = [
  ...
  },
  {
    ...
    options: {
      ...
      b: 'Hàm số không có giá trị nhỏ nhất trên khoảng \((0; + \\infty)\)',
  ...
  },
  {
    ...
    options: {
      ...
      d: 'Tồn tại \(x_{1},x_{2}\) sao cho \(f\\left( x_{1} \\right).f\\left( x_{2} \\right) < 0\)',
    },
    correctAnswer: 'b',
    showResult: true,
  },
...
const mockQuestionsVan: Question[] = [
  {
    id: 51,
    content: <div>
      <p><strong>Đọc đoạn trích sau đây và trả lời các câu hỏi từ 51 đến
        55:</strong></p>
  ...
  },
  {
    ...
    content:
      <div>
        <p><strong>Đọc đoạn trích sau đây và trả lời các câu hỏi từ 56 đến
          60:</strong></p>
  ...
  },
  {
    ...
    content:
      <div>
        <p><strong>Đọc đoạn trích và trả lời các câu hỏi từ 61 đến
          65:</strong></p>
  ...
  },
  {
    ...
    content:
      <div>
        <p><strong>Đọc đoạn trích sau đây và trả lời các câu hỏi từ 66 đến
          70:</strong></p>
...
const mockQuestionsHoa: Question[] = [
  ...
  {
    id: 129,
    content: <p>“Thủy triều đỏ hay còn gọi là tảo nở hoa là hiện tượng quá nhiều tảo sinh sản với số lượng nhanh trong nước. Các nhà khoa học gọi đây là &apos;hiện tượng tảo nở hoa độc hại&apos;. Thảm họa &apos;thủy triều đỏ&apos; ở Bình Thuận trung tuần tháng 7/2002 từng làm khoảng 90% sinh vật trong vùng triều, kể cả cá, tôm trong các lồng, bè bị tiêu diệt; môi trường bị ô nhiễm nặng, mấy tháng sau mới hồi phục”. Có bao nhiêu phát biểu sau đây đúng về hiện tượng trên? I. Tảo nở hoa gây hại cho các sinh vật biển là ví dụ về mối quan hệ ức chế - cảm nhiễm. II. Sự tồn tại của các loại tảo (gây hiện tượng thủy triều đỏ) là hoàn toàn không có lợi cho hệ sinh thái. III. Thắt chặt việc kiểm soát nguồn chất thải, nhất là ở vùng nuôi trồng thủy, hải sản là một trong những biện pháp hạn chế hiện tượng này. IV. Loại bỏ các loài tảo ra khỏi hệ sinh thái sẽ đảm bảo sự phát triển cân bằng của hệ sinh thái.</p>,
    type: "multiple_choice",
    options: {
      a: <span>1</span>,
      b: <span>3</span>,
  ...
  {
    id: 131,
    content: <p>Chọn nội dung ở cột I phù hợp với nội dung ở cột II trong bảng sau: I: 1. Phan Đình Phùng, 2. Nguyễn Tri Phương, 3. Phan Bội Châu, 4. Phan Chu Trinh. II: a. Khởi xướng phong trào Đông Du, b. Tổng đốc thành Hà Nội, c. Chủ trương cải cách dân chủ, d. Lãnh đạo cuộc khởi nghĩa Hương Khê.</p>,
    type: "multiple_choice",
    options: {
  ...
  {
    id: 138,
    content: <p>Cho bảng thống kê về thành tựu một số lĩnh vực của nước Mĩ sau Chiến tranh thế giới thứ hai như sau: Công nghiệp: Chiếm khoảng 56,4% sản lượng công nghiệp toàn thế giới (1948). Nông nghiệp: Đạt sản lượng gấp hai lần sản lượng của 5 nước Anh, Pháp, Tây Đức, Italia, Nhật Bản cộng lại. Tài chính: Chiếm 3/4 dự trữ vàng của thế giới. Thương mại: Kiểm soát 50% tàu bè đi lại trên biển. Từ bảng số liệu trên, cho biết nhận xét nào sau đây là chính xác nhất về tình hình kinh tế Mĩ trong hai thập niên đầu sau Chiến tranh thế giới thứ hai?</p>,
    type: "multiple_choice",
    options: {
  ...
  {
    id: 139,
    content: <p>Mỹ ném bom Hà Nội, Hải Phòng với sự tàn bạo hơn bao giờ hết trong lịch sử chiến tranh Việt Nam... Gạch vụn là mục tiêu thừa nhận của Lầu Năm Góc, nhằm &apos;làm tê liệt đời sống hàng ngày của Hà Nội và Hải Phòng và phá hủy khả năng của Bắc Việt Nam, ủng hộ các lực lượng của Nam Việt Nam&apos;. (Tổng cục Chính trị, &apos;Điện Biên Phủ trên không&apos; nhìn từ phía Mỹ, Thư viện Quân đội, Hà Nội, 2002, tr19) Nội dung nào sau đây là mục tiêu của Mỹ trong cuộc chiến tranh phá hoại miền Bắc Việt Nam lần thứ hai 1972?</p>,
    type: "multiple_choice",
    options: {
  ...
  {
    id: 140,
    content: <p>Mở cuộc tập kích chiến lược đường không bằng máy bay B52 vào Hà Nội, Hải Phòng và một số thành phố miền Bắc là thủ đoạn của Mỹ trong chiến lược chiến tranh nào sau đây?</p>,
    type: "multiple_choice",
    options: {
  ...
  {
    id: 143,
    content: <p>Tổ quốc tôi ba nghìn cây số biển Móng Cái - Cà Mau hình chiếc lưỡi câu Câu những túi vàng đen mỏ dầu trong lòng đất (Nguyễn Trọng Phú, Tổ quốc tôi ba nghìn cây số biển) Với hơn &apos;ba nghìn cây số biển&apos; giúp nước ta có bao nhiêu tỉnh/thành phố giáp biển?</p>,
    type: "multiple_choice",
    options: {
      a: <span>18</span>,
      b: <span>28</span>,
  ...
  {
    id: 146,
    content: <p>Cho bảng số liệu: DIỆN TÍCH VÀ SẢN LƯỢNG ĐIỀU CỦA NƯỚC TA, GIAI ĐOẠN 2017 - 2021 Năm: 2017, 2019, 2020, 2021; Diện tích (nghìn ha): 297,5, 295, 302,4, 314,4; Sản lượng (nghìn tấn): 212,3, 283,3, 348,5, 399,3 (Nguồn: Niên giám thống kê Việt Nam 2022, https://www.gso.gov.vn) Theo bảng số liệu, để thể hiện tốc độ tăng trưởng diện tích và sản lượng điều nước ta giai đoạn 2017 - 2021, dạng biểu đồ nào sau đây là thích hợp nhất?</p>,
    type: "multiple_choice",
    options: {
      a: <span>Miền.</span>,
      b: <span>Kết hợp.</span>,
...
export default function ExamResultPage({ params }: { params: { id: string } }) {
  ...
  useEffect(() => {
    ...
    if (result?.examId == '1') {
      result.questions = mockQuestionsMath;
    } else if (result?.examId == '2') {
      result.questions = mockQuestionsVan;
    } else if (result?.examId == '3') {
      result.questions = mockQuestionsHoa;
    }
    setExamResult(result);

    // Tính toán điểm số
    const total = result.results.length;
    const correct = result.results.filter((r: any) => r.isCorrect).length;

    setTotalQuestions(total);
    setCorrectAnswers(correct);
    setScore((correct / total) * 10);

    // // Xóa kết quả khỏi localStorage sau khi đã lấy
    ...
    return (
      <div className="container mx-auto px-4 py-8">
        <div className="text-center">
          <p className="text-red-500">Đang tải kết quả...</p>
        </div>
      </div>
    );
  }
    ...
    <div className="container mx-auto px-4 py-8">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-white rounded-lg shadow-md p-6 mb-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              ...
              <p className="font-medium">{examResult.studentInfo?.name}</p>
            </div>
            <div>
              <p className="text-gray-600">Email:</p>
              <p className="font-medium">{examResult.studentInfo?.email}</p>
            </div>
            <div>
              <p className="text-gray-600">Số điện thoại:</p>
              <p className="font-medium">{examResult.studentInfo?.phone}</p>
            </div>
            <div>
              <p className="text-gray-600">Thời gian làm bài:</p>
              <p className="font-medium">
                {Math.floor(examResult.timeSpent / 60)} phút {examResult.timeSpent % 60} giây
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-lg shadow-md p-6 mb-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-center">
            <div className="p-4 bg-blue-50 rounded-lg">
              <p className="text-gray-600">Tổng số câu hỏi</p>
              <p className="text-2xl font-bold text-[#3d82af]">{totalQuestions}</p>
            </div>
            ...
            <div className="p-4 bg-purple-50 rounded-lg">
              ...
              <p className="text-2xl font-bold text-purple-600">{score.toFixed(1)}</p>
            </div>
          </div>
        </div>
        ...
        <div className="mt-8 space-y-6">
          {examResult.questions.map((question: Question, index: number) => {
            const result = examResult.results.find((r: any) => r.questionId === question.id);
            return (
              <div key={question.id} className="bg-white rounded-lg shadow-md p-6">
                <div className="mb-4">
                  ...
                  <div className="text-gray-700 mt-2">{question.content}</div>
                </div>
                  ...
                  <div className="space-y-3">
                    {Object.entries(question.options).map(([key, value]) => {
                      ...
                      return (
                        <div
                          key={key}
                          className={`p-3 border rounded-md ${isCorrectAnswer
                        ...
                        >
                          <div className="flex items-center justify-between">
                            ...
                            <div className="flex items-center gap-2">
                              {isUserAnswer && (
                                <span className="text-blue-600 text-sm">Câu trả lời của bạn</span>
                              )}
                              {isCorrectAnswer && (
                ...
                {question.type === 'essay' && (
                  <div className="mt-4 space-y-3">
                    <div className={`p-3 border rounded-md ${result?.isCorrect
                        ? 'border-green-500 bg-green-50'
                        : 'border-red-500 bg-red-50'
                      }`}>
                      <div className="flex items-center justify-between">
                        <p className="text-gray-600">Câu trả lời của bạn:</p>
                        {result?.isCorrect ? (
                          <FaCheckCircle className="text-green-500" />
                        ) : (
                          <FaTimesCircle className="text-red-500" />
                      ...
                      <p className="font-medium mt-1">{result?.userAnswer || 'Chưa trả lời'}</p>
                    </div>
